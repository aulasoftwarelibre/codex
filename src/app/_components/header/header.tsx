...
import HeaderAuthenticatedMenu from '@/app/_components/header/header-authenticated-menu'
import HeaderSearchInput from '@/app/_components/header/header-search-input'
import HeaderUnauthenticatedMenu from '@/app/_components/header/header-unauthenticated-menu'
